...
public class LoginReslution : MonoBehaviour
{
#if UNITY_ANDROID
	...
	void Update () {
		...
		if(UIRoot != null){
			...
			if(uiroot != null){
				// (960+1312)/2=1136,1136为封面图高度
				uiroot.manualHeight = 1024;
				uiroot.maximumHeight = 1952;
	...
	//{
		...
		if(GUILayout.Button("add",GUILayout.Height(64)))
        {   
			camera.orthographicSize+=0.1f;
        }
		if(GUILayout.Button("sub",GUILayout.Height(64)))
        {   
			camera.orthographicSize-=0.1f;
        }*/
	//}
