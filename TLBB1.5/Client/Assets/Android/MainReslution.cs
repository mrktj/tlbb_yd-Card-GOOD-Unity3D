...
public class MainReslution : MonoBehaviour
{
#if UNITY_ANDROID
	...
	void Update () {
		...
		else
		{
			...
			camera.orthographicSize = r*1.0746f;//1.0746是经验值//
		}*/
	...
	//void OnGUI()
	//{
		// 09_17_1955 build time
		//if(GUILayout.Button(version_time,GUILayout.Height(64)))
        //{   
        //}
		
        /*if(GUILayout.Button(camera.orthographicSize.ToString(),GUILayout.Height(100)))
        {   
        }
		if(GUILayout.Button(hw.ToString(),GUILayout.Height(100)))
        {   
        }
		if(GUILayout.Button("add",GUILayout.Height(100)))
        {   
			camera.orthographicSize+=0.2f;
        }
		if(GUILayout.Button("sub",GUILayout.Height(100)))
        {   
			camera.orthographicSize-=0.2f;
        }*/
	//}
