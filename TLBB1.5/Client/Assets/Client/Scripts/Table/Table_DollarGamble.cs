...
[Serializable]
 public class Tab_DollarGamble : ITableOperate
{ private const string TAB_FILE_DATA = "dollar_gamble.txt";
 public enum _ID
 {
 INVLAID_INDEX=-1,
ID_STAR,
...
private int m_GambleControl;
 public int GambleControl { get{ return m_GambleControl;}}
...
public bool LoadTable(Hashtable _tab)
 ...
 Tab_DollarGamble _values = new Tab_DollarGamble();
 _values.m_CardID =  Convert.ToInt32(valuesList[(int)_ID.ID_CARDID] as string);
_values.m_GambleControl =  Convert.ToInt32(valuesList[(int)_ID.ID_GAMBLE_CONTROL] as string);
