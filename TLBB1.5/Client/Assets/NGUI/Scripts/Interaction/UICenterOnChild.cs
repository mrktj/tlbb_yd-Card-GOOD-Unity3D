...
public class UICenterOnChild : MonoBehaviour
{
	...
	void OnDragFinished (UIDraggablePanel.DragonMode dragonMode) { if (enabled) Recenter(); }
	...
	public void Recenter ()
	{
		...
		Vector3 offsetCenter = center - mDrag.currentMomentum * (mDrag.momentumAmount * 0.1f) * 3;
