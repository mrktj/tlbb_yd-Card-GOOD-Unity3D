...
public class UIScrollBar : MonoBehaviour
{
	...
	public delegate void OnDragFinished (UIDraggablePanel.DragonMode dragonMode);
	...
	void OnPressBackground (GameObject go, bool isPressed)
	{
		...
		if (!isPressed && onDragFinished != null) onDragFinished(UIDraggablePanel.DragonMode.None);
	}
	...
	void OnPressForeground (GameObject go, bool isPressed)
	{
        ...
        else if (onDragFinished != null) onDragFinished(UIDraggablePanel.DragonMode.None);
	}
