...
public class UICamera : MonoBehaviour
{
	...
	//edit by zbz
	public enum TouchInSideOrOutSide
	{
		None,
		TouchInSide,
		TouchOutSide,
	...
	public class MouseOrTouch
	{
		...
		//edit by zbz
		public TouchInSideOrOutSide curTouchInOrOut = TouchInSideOrOutSide.None;
		public TouchInSideOrOutSide OnMessageTouchInOrOut = TouchInSideOrOutSide.None;
		public UIButtonMessage btnMessage;
		public GameObject touchInOrOutObj = null;
		public TouchPhase touchPhase = TouchPhase.Began;
		
		//edit by zbz
		public GameObject touchOverObj = null;
		public TouchInSideOrOutSide OnMessageTouchOver = TouchInSideOrOutSide.None;
		public int nDelayOverTime = -1;
	}
	...
	public const int MaxDelayOverTime = 4;
	/// <summary>
	...
	static public RaycastHit touchInOrOutObj;
	...
	public void ProcessTouch (bool pressed, bool unpressed)
	{
		...
		else
		{
			...
			//做MoveInOrOut
			if(currentTouch.OnMessageTouchInOrOut != TouchInSideOrOutSide.None)
			{
				Debug.Log("currentTouch.OnMessageTouchInOrOut != TouchInSideOrOutSide.None");
				if(currentTouch.OnMessageTouchInOrOut == TouchInSideOrOutSide.TouchInSide)
				{
					Debug.Log("currentTouch.OnMessageTouchInOrOut == TouchInSideOrOutSide.TouchInSide");
					Notify(currentTouch.touchInOrOutObj, "OnTouchMoveIn", true);
				}
				else if(currentTouch.OnMessageTouchInOrOut == TouchInSideOrOutSide.TouchOutSide)
				{
					Debug.Log("currentTouch.OnMessageTouchInOrOut == TouchInSideOrOutSide.TouchOutSide");
					Notify(currentTouch.touchInOrOutObj, "OnTouchMoveOut", true);
				}
				
				currentTouch.OnMessageTouchInOrOut = TouchInSideOrOutSide.None;
			}
			
			if(currentTouch.OnMessageTouchOver == TouchInSideOrOutSide.TouchOver)
			{
				Notify(currentTouch.touchOverObj, "OnTouchOver", true);
			}
