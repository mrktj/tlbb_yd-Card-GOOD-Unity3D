...
public class Table_Randomname implements ITableOperate {
 public final static String TAB_FILE_DATA = "/randomname.txt";
...
public boolean LoadTable(HashMap<Integer, Table_Randomname> _tab) throws TableException
 {
 ...
 HashMap<Integer, Table_Randomname> _hash = (HashMap<Integer, Table_Randomname> )obj;
 if (skey.isEmpty())
 {
 ...
 Table_Randomname _values = new Table_Randomname();
