...
public class Table_TableModel implements ITableOperate {
 public final static String TAB_FILE_DATA = "/TableModel.txt";
...
public static final int ID_EXAMPLE = 6 ;
...
public boolean LoadTable(HashMap<Integer, Table_TableModel> _tab) throws TableException
 {
 ...
 HashMap<Integer, Table_TableModel> _hash = (HashMap<Integer, Table_TableModel> )obj;
 if (skey.isEmpty())
 {
 ...
 Table_TableModel _values = new Table_TableModel();
...
_values.m_Example =  (String)valuesList.get(ID_EXAMPLE);
